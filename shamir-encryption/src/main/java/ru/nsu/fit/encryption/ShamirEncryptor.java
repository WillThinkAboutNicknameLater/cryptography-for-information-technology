...
public class ShamirEncryptor {
    private final Logger logger;

    public ShamirEncryptor() {
        this.logger = LogManager.getLogger(ShamirEncryptor.class);
    }
    ...
    public int calculateX(int number, int degree, int modulo) {
        return MathHelper.pow(number, degree, modulo);
    }
}
